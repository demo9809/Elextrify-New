        ...
        <div className="bg-white border border-[#E5E7EB] rounded-lg overflow-hidden">
          ...
          <div className="p-6">
                ...
                <div>
                  <div className="flex items-start justify-between mb-6">
                    <div>
                      ...
                      <p className="text-sm text-[#6B7280]">Your plan and billing information</p>
                    </div>
                    <span
                      className={`inline-flex items-center px-2.5 py-1 rounded-md border text-xs font-medium ${getSubscriptionStatusColor(
                        subscription.status
                      )}`}
                    >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {subscription.billingCycle === 'monthly' && (
                            <span className="text-sm text-[#16A34A]">
                              Save{' '}
                              {formatCurrency(
                                getCycleSavings(subscription.price),
                      ...
                      {primaryPaymentMethod && (
                        <div>
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <p className="font-medium text-[#111827]">
                              {primaryPaymentMethod.cardBrand?.toUpperCase()} ••••{' '}
                        ...
                        <div key={item.name}>
                          ...
                          {status === 'warning' && (
                            <div className="flex items-center gap-1 mt-2">
                              ...
                              <p className="text-xs text-[#F59E0B]">You're approaching your limit</p>
                            </div>
                          )}
                    ...
                    <div className="flex items-center justify-between p-4 bg-[#F9FAFB] rounded-lg">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-[#6B7280]">
                            Expires {primaryPaymentMethod.expiryMonth}/
                            {primaryPaymentMethod.expiryYear}
                          </p>
                      ...
                      <div className="mt-4 p-3 bg-[#FEF2F2] border border-[#FECACA] rounded-lg flex items-start gap-2">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-[#991B1B]">
                            {billingData.lastPaymentAttempt.message ||
            ...
            {activeTab === 'invoices' && (
              <div>
                <div className="mb-6">
                  <h2 className="font-semibold text-[#111827] mb-1">Invoice History</h2>
                  <p className="text-sm text-[#6B7280]">View and download your past invoices</p>
                </div>

                {/* Desktop Table */}
                <div className="hidden lg:block overflow-x-auto border border-[#E5E7EB] rounded-lg">
                    ...
                    <tbody className="divide-y divide-[#E5E7EB] bg-white">
                      {invoices.map((invoice) => (
                        <tr key={invoice.id} className="hover:bg-[#F9FAFB] transition-colors">
                          ...
                          <td className="px-6 py-4">
                            <span
                              className={`inline-flex items-center px-2.5 py-1 rounded-md border text-xs font-medium ${getInvoiceStatusColor(
                                invoice.status
                              )}`}
                            >
