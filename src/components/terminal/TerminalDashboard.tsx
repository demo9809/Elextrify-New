...
export function TerminalDashboard({ onViewDevice, onNavigateToRegistration, onOpenLocationProfile }: TerminalDashboardProps) {
    ...
    <div className="min-h-screen bg-[#F9FAFB]">
      <div className="p-8">
        ...
        <div className="mb-8 flex items-start justify-between">
          <div>
            ...
            <p className="text-[#6B7280]">
              Monitor and manage all kiosk hardware across your network
            </p>
          </div>
          <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
          ...
          <div className="bg-white border border-[#E5E7EB] rounded-xl p-6">
            <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-sm text-[#6B7280]">Total Devices</p>
            </div>
            <p className="text-[#111827] text-3xl font-semibold">{stats.total}</p>
          </div>
          ...
          <div className="bg-white border border-[#E5E7EB] rounded-xl p-6">
            ...
            <p className="text-[#16A34A] text-3xl font-semibold">{stats.online}</p>
          </div>
          ...
          <div className="bg-white border border-[#E5E7EB] rounded-xl p-6">
            ...
            <p className="text-[#DC2626] text-3xl font-semibold">{stats.offline}</p>
          </div>
          ...
          <div className="bg-white border border-[#E5E7EB] rounded-xl p-6">
            ...
            <p className="text-[#F59E0B] text-3xl font-semibold">{stats.warning}</p>
          </div>
          ...
          <div className="bg-white border border-[#E5E7EB] rounded-xl p-6">
            ...
            <p className="text-[#111827] text-sm font-medium">{formatLastSeen(lastSync.toISOString())}</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-[#E5E7EB] overflow-hidden">
          {/* Search and Filters */}
          <div className="px-6 py-4 border-b border-[#E5E7EB] flex items-center gap-4 bg-white">
            {/* Search */}
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="h-10 px-3 bg-white border border-[#E5E7EB] rounded-lg text-sm text-[#111827] focus:outline-none focus:ring-2 focus:ring-[#D9480F] focus:border-transparent"
              >
          ...
          {/* Table Header - Only show in table view */}
          {viewMode === 'table' && (
